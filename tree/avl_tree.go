...
func getHeight[K Ordered, V any](n *Node[K, V]) int {
	if n == nil {
		return 0
	}
	return n.height
...
func getBalanceFactor[K Ordered, V any](n *Node[K, V]) int {
...
func isValidBST[K Ordered, V any](n *Node[K, V]) bool {
	if n == nil {
		return true
	}
	if n.left != nil {
...
func isBalanced[K Ordered, V any](n *Node[K, V]) bool {
	if n == nil {
		return true
	}
